    ...
    <div className="container px-5 py-24 mx-auto">
      <div className="lg:w-4/5 mx-auto flex flex-wrap">
        <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
          <h2 className="text-sm title-font text-gray-500 tracking-widest">CHARIZARD</h2>
          <h1 className="text-gray-900 text-3xl title-font font-medium mb-4">YOUR ORDER</h1>
          ...
          <p className="leading-relaxed mb-4 text-green-500 font-semibold">YOUR ORDER HAS BEEN SUCCESSFULY PLACED</p>
          ...
          <div className="flex border-t border-gray-200 py-2">
            ...
            <span className="ml-auto text-gray-900">1</span>
            <span className="ml-auto text-gray-900">₹50000</span>
          </div>
          <div className="flex border-t border-b mb-6 border-gray-200 py-2">
            <span className="text-gray-500">SMARTPHONE</span>
            <span className="ml-auto text-gray-900">1</span>
            <span className="ml-auto text-gray-900">₹20000</span>
          </div>
          <div className="flex">
            <span className="title-font font-medium text-2xl text-gray-900">₹70500</span>
